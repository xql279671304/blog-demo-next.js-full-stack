...
type PreparedStatement<T> = PgPreparedQuery<
  PreparedQueryConfig & {
    execute: T | undefined;
  }
>;
...
interface DrizzleAdapterConfig {
  schemas: {
    user: PgTableWithColumns<any>;
    account: PgTableWithColumns<any>;
    session: PgTableWithColumns<any>;
    verificationToken: PgTableWithColumns<any>;
  };
  prepared?: {
